# Kehe Ye's Personal CV Website

This is a single-page CV website built with Jekyll and GitHub Pages.

## About

This website displays my academic CV, including:
...
- `_pages/about.md` - Main CV content
...
The website uses a simplified single-page layout with:
- No navigation bar
- No sidebar
